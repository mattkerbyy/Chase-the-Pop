...
const services = [
  {
    ...
    icon: Package,
    image: "/images/homePage/funko-pop-collectibles.png",
    accent: "bg-blue-500",
    isHighlighted: true,
  },
  {
    ...
    icon: Star,
    image: "/images/homePage/pop-mart-collectibles.png",
    accent: "bg-red-500",
    isHighlighted: true,
  },
  {
    ...
    icon: Calendar,
    image: "/images/homePage/pre-order-services.png",
    accent: "bg-green-500",
    isHighlighted: true,
  },
  {
    ...
    icon: Search,
    image: "/images/homePage/custom-sourcing.png",
  ...
  },
  {
    ...
    icon: Shield,
    image: "/images/homePage/collectible-assessment.png",
